	...
	int *num_empty_demes, int *num_extinct_driver_genotypes)
{
	...
	*num_cells = init_pop;
	...
	// genotypes:
	genotype_ints[POPULATION][0] = init_pop - init_mutant_pop;
	...
	*next_genotype_id = 1;
	...
	// driver genotypes:
	driver_genotype_ints[POPULATION][0] = init_pop - init_mutant_pop;
	...
	*next_driver_genotype_id = 1;
	...
	// genotypes:
	genotype_ints[POPULATION][1] = init_mutant_pop;
	genotype_ints[IDENTITY][1] = 1; // unique ID
	genotype_ints[DRIVER_IDENTITY][1] = 1; // unique ID
	genotype_ints[PARENT][1] = 0; 
	genotype_ints[NUM_DRIVER_MUTATIONS][1] = init_driver_birth_mutations + 1; // number of drivers
	genotype_ints[NUM_MIGRATION_MUTATIONS][1] = init_driver_mig_mutations; // number of drivers
	genotype_ints[IMMORTAL][1] = 1; // don't overwrite this genotype
	genotype_ints[NUM_PASSENGER_MUTATIONS][1] = init_passengers; // number of passengers
	*next_genotype_id = 2;
	// set genotype birth and miration rates:
	...
	// driver genotypes:
	driver_genotype_ints[POPULATION][1] = init_mutant_pop;
	driver_genotype_ints[IDENTITY][1] = 1;
	driver_genotype_ints[DRIVER_IDENTITY][1] = 1;
	driver_genotype_ints[PARENT][1] = 0;
	driver_genotype_ints[NUM_DRIVER_MUTATIONS][1] = init_driver_birth_mutations + 1; // number of drivers
	driver_genotype_ints[NUM_MIGRATION_MUTATIONS][1] = init_driver_mig_mutations; // number of drivers
	driver_genotype_ints[IMMORTAL][1] = 1; // don't overwrite this genotype
	driver_genotype_ints[NUM_PASSENGER_MUTATIONS][1] = init_passengers; // number of passengers
	*next_driver_genotype_id = 1;
	// set driver genotype birth and miration rates:
	driver_genotype_floats[BIRTH_RATE][1] = genotype_floats[BIRTH_RATE][1];
	driver_genotype_floats[MIGRATION_RATE][1] = genotype_floats[MIGRATION_RATE][1];
	driver_genotype_floats[ORIGIN_TIME][1] = 0; // generation at which genotype originated
	driver_genotype_floats[THRESHOLD_TIME][1] = -1; // generation at which genotype population exceeded minimum threshold
